...
import com.top.planer.databinding.ActivityCalendarBinding
import com.top.planer.entities.Calendar
import com.top.planer.entities.Notes
import com.top.planer.gui.AdapterCalendarList
import com.top.planer.gui.AddingEventActivity
import com.top.planer.gui.CalendarAdapter
...
class CalendarFragment : Fragment(), CalendarAdapter.OnItemListener, CalendarAdapter.OnLongItemListener {
    ...
    override fun onItemClick(position: Int, dayText: String?) {
        if (dayText != "") {
            ...
            {
                adapter.updateList(mutableListOf<com.top.planer.entities.Calendar>())
            }
        }
        setMonthView()
    }
